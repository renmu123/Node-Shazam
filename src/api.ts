...
export class Shazam {
  ...
  async fullRecognizeSong(
    ...
    while (true) {
      ...
      const results = await this.endpoint.formatAndSendRecognizeRequest(
        signature,
        language,
      );
   ...
   */
  async recognise(pathOrBuffer: string | Buffer, language: string = "en") {
  ...
  async top_tracks_global(
    language: string = "en-US",
    endpoint_country: string = "GB",
    limit: string = "10",
    offset: string = "0",
  ) {
    const url = ShazamURLS.top_tracks_global(
      language,
      endpoint_country,
      limit,
      offset,
    ...
    return await (
      await fetch(url, { headers: this.headers(language), method: "GET" })
    ).json();
  }
  ...
  async top_tracks_country(
    ...
    const url = ShazamURLS.top_tracks_country(
      language,
      endpoint_country,
      country_code,
      limit,
  ...
  async top_tracks_city(
    ...
    const url = ShazamURLS.top_tracks_city(
      language,
      endpoint_country,
      city_id,
      limit,
  ...
  async top_genre_tracks_world(
    ...
    const url = ShazamURLS.genre_world(
      language,
      endpoint_country,
      genre,
      limit,
   ...
   * @param {string} offset the offset to start fetching from
   */
  async top_genre_tracks_country(
    language: string,
    endpoint_country: string,
    country: string,
    genre: string,
    ...
    const url = ShazamURLS.genre_country(
      language,
      endpoint_country,
      country,
      genre,
  ...
  async related_songs(
    ...
    const url = ShazamURLS.related_songs(
      language,
      endpoint_country,
      track_id,
      offset,
  ...
  async search_artist(
    ...
    const url = ShazamURLS.search_artist(
      language,
      endpoint_country,
      query,
      limit,
  ...
  async artist_albums(
    ...
    const url = ShazamURLS.artist_albums(
      endpoint_country,
      artist_id,
      limit,
      offset,
  ...
  async search_music(
    ...
    const url = ShazamURLS.search_music(
      language,
      endpoint_country,
      query,
      limit,
